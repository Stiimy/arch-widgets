...
Item {
    ...
    readonly property string scriptsDir: Quickshell.env("HOME") + "/.config/quickshell/network-widget"
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.fillHeight: true
                        visible: window.btPresent || window.wifiPresent
                        radius: window.s(10)
                        ...
                        Text {
                            ...
                            color: refreshMa.containsMouse ? window.text : window.subtext0
                            text: "󰑐"
                        }
                        MouseArea {
                            id: refreshMa
                            ...
                            onClicked: {
                                ...
                                if (window.activeMode === "bt") {
                                    btPoller.running = true
                                    Quickshell.execDetached(["bash", window.scriptsDir + "/bluetooth_panel_logic.sh", "--status"])
                                } else if (window.activeMode === "wifi") {
